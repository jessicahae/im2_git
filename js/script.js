...
const section_moodbiter = document.querySelector('#mood-biter');
const section_moodquestion = document.querySelector('#mood-question');
...
button_next.addEventListener('click', function () {
    section_moodbiter.classList.remove('hidden');
    section_moodquestion.classList.add('hidden');
});

/* transfer to different moods */
...
const section_brainrot = document.querySelector('#mood-brainrot');
const section_silly = document.querySelector('#mood-silly');
const section_positive = document.querySelector('#mood-positive');

button_brainrot.addEventListener('click', function () {
    section_brainrot.classList.remove('hidden');
    section_moodbiter.classList.add('hidden');
});

button_silly.addEventListener('click', function () {
    section_silly.classList.remove('hidden');
    section_moodbiter.classList.add('hidden');
});

button_positive.addEventListener('click', function () {
    section_positive.classList.remove('hidden');
    section_moodbiter.classList.add('hidden');
});
